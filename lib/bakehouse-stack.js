...
export class RuonaBakehouseStack extends Stack {
  constructor(scope, id, props) {
    ...
    const role = new iam.Role(this, "GitHubActionsRole", {
      roleName: `github-actions-${props.subDomain}-${props.githubRepo}`, // 👈 yourName added here
      assumedBy: new iam.WebIdentityPrincipal(
        provider.openIdConnectProviderArn,
        {
          ...
          StringLike: {
            "token.actions.githubusercontent.com:sub": `repo:${props.githubOrg}/${props.githubRepo}:${props.githubRefFilter}`,
          },
        },
      ),
